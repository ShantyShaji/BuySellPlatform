...
const Register = () => {
  ...
  return (
    <div className="w-full h-auto">
      <Navbar />
      <div className="w-full h-auto lg:h-[89vh] xl:h-auto my-0 lg:my-14 xl:my-9 lg:overflow-hidden flex items-center justify-center">
        <div className="w-[80vw] lg:w-[84vw] h-auto border border-[#DFDFDF] rounded-3xl flex flex-col lg:flex-row items-center justify-center bg-[#F509640A] mt-16">
          {/* Left Panel */}
          <div className="w-full lg:w-[60%] h-auto flex flex-col items-center justify-center gap-3 py-7 bg-white">
            <img src="/logo.png.png" alt="company logo" className="h-6" />
            <p className="text-sm text-center text-gray-500">
